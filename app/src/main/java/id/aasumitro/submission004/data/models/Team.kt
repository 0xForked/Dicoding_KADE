...
import id.aasumitro.submission004.util.AppConst.TABLE_TEAMS
import id.aasumitro.submission004.util.AppConst.TABLE_TEAMS_COLUMN_BANDAGE
import id.aasumitro.submission004.util.AppConst.TABLE_TEAMS_COLUMN_NAME
import id.aasumitro.submission004.util.AppConst.TABLE_TEAMS_COLUMN_NAME_SHORT
import id.aasumitro.submission004.util.AppConst.TABLE_TEAMS_COLUMN_STADIUM
import id.aasumitro.submission004.util.AppConst.TABLE_TEAMS_COLUMN_UID
import kotlinx.android.parcel.Parcelize

@Parcelize
@Entity(tableName = TABLE_TEAMS,
        indices = [Index(value = [TABLE_TEAMS_COLUMN_UID], unique = true)])
data class Team(
